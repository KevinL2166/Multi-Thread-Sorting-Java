...
public class MultithreadSort {
	...
	public static void main(String[] args) throws InterruptedException  
	{
		...
		System.out.println("Number of threads running: " + fjp.getParallelism());
		long startTime;
		long endTime;
		...
		System.out.println("Time taken " + "for array size " + ARRAY_SIZE + " with MergeSort (Multi) " +
		...
		endTime = System.currentTimeMillis();
		System.out.println("Time taken " + "for array size " + ARRAY_SIZE + " with QuickSort (Multi) " +
				(endTime - startTime) + " millis");
	}
}
