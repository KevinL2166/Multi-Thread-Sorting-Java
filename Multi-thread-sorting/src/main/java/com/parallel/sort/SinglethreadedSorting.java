...
public class SinglethreadedSorting {
	...
	static class QuickSort {
		...
		{
			if (low + THRESHOLD > high) {insertionsort(low, high);}
			else {
				if(low < high) {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Time taken " + "for array size " + ARRAY_SIZE + " with MergeSort (Single) " +
		...
		System.out.println("Time taken " + "for array size " + ARRAY_SIZE + " with QuickSort (Single) " +
				(endTime - startTime) + " millis");
